...
public class PageClass {
    ...
    private By firstProductImage = By.xpath("");
    ...
    private By editAddressBtn = By.xpath("//*[@id=\"item475960219e\"]/div/div[1]/div/a/div/img");
    ...
    public void addProductToCart(String product) {
        ...
        driver.findElement(By.xpath("//*[@id=\"s0-55-0-9-8-4-4-0-3-0-1[0]-0-2-0-2-0-1-2-container\"]/button[1]")).click();
    ...
    public void changeAddress(String newAddress, String city) {
        ...
        driver.findElement(By.id("addressLine1")).sendKeys(newAddress);
        driver.findElement(By.id("addressLine1")).click();
